...
bool ESPTAB::esp_enabled = false;

// Display type control variables
bool ESPTAB::show_monster = true;
bool ESPTAB::show_npc = true;
bool ESPTAB::show_friendly = true;
bool ESPTAB::show_puzzle = true;
bool ESPTAB::show_all = false;

// Display info control variables
bool ESPTAB::show_distance = true;
bool ESPTAB::show_configid = false;
bool ESPTAB::show_configname = true;
bool ESPTAB::show_entityid = false;
bool ESPTAB::show_type = false;

void ESPTAB::Render() {
	if (ImGui::BeginTabItem("ESP")) {
		ImGui::Spacing();
		
		ImGui::TextColored(ImVec4(1.0f, 0.5f, 1.0f, 1.0f), "ESP Features");
		ImGui::Separator();
		ImGui::Spacing();
...
EntityDisplayInfo ESPTAB::getEntityDisplayInfo(app::EEntityType__Enum type) {
...
std::string ESPTAB::addtext(std::string& text, std::string newtext, bool first) {
	if (!first && !text.empty()) {
		text += " | ";
	}
	text += newtext;
...
std::string ESPTAB::addtext(std::string& text, std::string newtext) {
